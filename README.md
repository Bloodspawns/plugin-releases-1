...
- Directional Path
- Hide Bloat Tank
- Null Bloat Tank Tiles (Top of the tank tiles)
- Hide Ceiling Chains
- Salve Flicking
...
+ 12/3/2020 Fixed Bloat Hands issue overriding per hand displaying a new tick counter post hand despawn
+ 12/3/2020 Added more objects to hide from the Bloat tank
+ 12/3/2020 Added feature to hide the ceiling chains in Bloat
+ 12/11/2020 Fixed issue with Nylocas Boss displaying incorrect ticks on spawn (My bad... :gottago:)
...
+ 12/23/2020 Added ability to customize the color of entrance/exit barriers
...
+ 2/13/2021 Updated to reflect lastest API change
+ 2/13/2021 Potentially fixed bug where the plugin wasn't resetting after each raid
+ 2/17/2021 Added Bloat Salve Flicking
+ 3/3/2021 Updated to reflect lastest API change
+ 3/24/2021 Hopefully fixed the removal of the top plane above the Bloat tank (Requires GPU mode)
+ 3/29/2021 Another Bloat top plane revert
+ 4/3/2021 Finally found a fix for the bloat tiles, and can remove them entirely
+ 4/3/2021 Added 'Null Bloat Tank Tiles'
+ 4/10/2021 Updated 'Remove FRC Flag' to work with new reward chests at bank
+ 4/14/2021 Added 'Hide Smalls Spotanims' to hide the spotanimations that occur when smalls die
+ 4/30/2021 Added Saradomin's non-blessed/blessed sword to Wheelchair
+ 6/3/2021 Partially updated to be compatible with Story Mode/Hardmode (There is some issues)
...
+ 6/25/2021 Updated to reflect latest RuneLite API update
+ 7/29/2021 Fixed Maiden Proc Threshold to reflect the proper scale
+ 7/29/2021 Added Blade of Saeldor variants to Nylocas Wheelchair
+ 7/29/2021 Added Bow of Faerdhinen variants to Nylocas Wheelchair
+ 7/29/2021 Added Crystal Bow variants to Nylocas Wheelchair
+ 7/29/2021 Added Dragon Halberd to Nylocas Wheelchair
+ 7/29/2021 Added Dragon Dagger variants to Verzik Purple MES
```
...
```diff
+ 4/18/2021 - custom rgb will now take in account of pixel brightness to appear more as a real hitsplat
+ 7/29/2021 - Updated to reflect latest RuneLite API change
```
...
```diff
- Overload Timer Unit of Time
- Prewarn before the 15 Second Modulo
- 15 Second Modulo
```
...
+ 3/30/2021 - Added reward permits prediction
+ 3/30/2021 - Added more upcoming fire tracking
```
